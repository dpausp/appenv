...
def test_reset_removes_venv(tmp_path, capsys, test_settings):
    """reset() warns about .venv directory it does not manage."""
...
def test_reset_removes_venv_symlink(workdir, monkeypatch, capsys, test_settings):
...
def test_reset_removes_old_venv_directory(workdir, monkeypatch, capsys, test_settings):
    """reset() warns about .venv directory but does not remove it."""
    base = Path(workdir)
