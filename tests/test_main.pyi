...
def mock_ensure_python(monkeypatch) -> None: ...
...
def test_run_script_delegates(monkeypatch, tmp_path, test_settings): ...
...
def test_uv_sync_with_extras(tmp_path, monkeypatch) -> None: ...
