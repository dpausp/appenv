...
def find_project_base(base: Path) -> Path: ...
def main() -> None: ...
...
def _run_uv_lock_diff(base: Path, verbose: bool) -> str: ...
def _print_lockfile_summary(old_lines: set[str], new_lines: set[str]) -> None: ...
