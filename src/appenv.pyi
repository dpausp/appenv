...
APPENV_SETTINGS_DESCRIPTIONS: dict[str, tuple[str, str]]
...
class AppEnv:
    ...
    def show_settings(
        self, _args: Namespace | None = None, _remaining: list[str] | None = None
    ) -> None: ...
    def profile_list(
        self, args: Namespace, remaining: list[str] | None = None
    ) -> None: ...
    def profiling_show(
        self, args: Namespace, remaining: list[str] | None = None
    ) -> None: ...
    ...
    def _find_profile(
        self, args_file: str | None, message_prefix: str = ...
    ) -> Path: ...
